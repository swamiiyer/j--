...
public class NNaiveRegisterAllocator extends NRegisterAllocator {
    ...
    public void allocation() {
        // In this allocation scheme, each interval just has a single range spanning the entire cfg.
        ...
        // Make sure that inputs of LIR instructions are not all assigned the same register.
        // Also, handle spills (ie, generate loads and stores where needed).
